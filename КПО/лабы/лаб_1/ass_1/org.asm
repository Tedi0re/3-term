														...
														;4)Решение->Свойства->Microsoft Macro Assembler->Listing File->Assembler Code Listing File $(IntDir) [название файла]
														;5)Решение->Свойства->Компоновщик->Система->Подсистема Windows(/SUBSYSTEM:WINDOWS)
